...
// OwnerDrawHeaderCtrlSample.cpp : アプリケーションのクラス動作を定義します。
//
...
// COwnerDrawHeaderCtrlSampleApp コンストラクション
...
// 唯一の COwnerDrawHeaderCtrlSampleApp オブジェクトです。

COwnerDrawHeaderCtrlSampleApp theApp;


// COwnerDrawHeaderCtrlSampleApp 初期化
