================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: OwnerDrawHeaderCtrlSample プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した OwnerDrawHeaderCtrlSample には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには OwnerDrawHeaderCtrlSample アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

OwnerDrawHeaderCtrlSample.vcxproj
...
OwnerDrawHeaderCtrlSample.vcxproj.filters
...
OwnerDrawHeaderCtrlSample.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   COwnerDrawHeaderCtrlSampleApp アプリケーション クラスを宣言します。

OwnerDrawHeaderCtrlSample.cpp
   これは、アプリケーション クラス COwnerDrawHeaderCtrlSampleApp を含むメイン アプリケー
   ション ソース ファイルです。

OwnerDrawHeaderCtrlSample.rc
...
res\OwnerDrawHeaderCtrlSample.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル OwnerDrawHeaderCtrlSample.rc に含まれていま
   す。

res\OwnerDrawHeaderCtrlSample.rc2
...
OwnerDrawHeaderCtrlSampleDlg.h, OwnerDrawHeaderCtrlSampleDlg.cpp - ダイアログ
   これらのファイルは COwnerDrawHeaderCtrlSampleDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な OwnerDrawHeaderCtrlSample.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   OwnerDrawHeaderCtrlSample.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
...
OwnerDrawHeaderCtrlSample.manifest
